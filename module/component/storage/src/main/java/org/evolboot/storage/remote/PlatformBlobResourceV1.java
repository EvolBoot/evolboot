...
/**
 * Platform Blob Resource
 * 平台文件管理 - 超管和员工可访问
 */
@RestController
@RequestMapping("/v1/platform/storage/blob")
@Tag(name = "平台文件管理", description = "平台文件管理")
@Slf4j
@AdminClient
public class PlatformBlobResourceV1 {

    private final BlobAppService service;

    public PlatformBlobResourceV1(BlobAppService service) {
