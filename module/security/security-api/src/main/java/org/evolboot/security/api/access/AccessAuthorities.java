...
public interface AccessAuthorities {
    ...
    String ROLE_TENANT_OWNER = "ROLE_TENANT_OWNER", HAS_ROLE_TENANT_OWNER = ROLE_PREFIX + ROLE_TENANT_OWNER + ROLE_SUFFIX;
    String ROLE_TENANT_STAFF = "ROLE_TENANT_STAFF", HAS_ROLE_TENANT_STAFF = ROLE_PREFIX + ROLE_TENANT_STAFF + ROLE_SUFFIX;
