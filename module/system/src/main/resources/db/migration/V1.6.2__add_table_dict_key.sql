-- 字典key
DROP TABLE IF EXISTS evoltb_system_dict_key;
CREATE TABLE evoltb_system_dict_key
(
...
create unique index evoltb_system_dict_key_key__uindex
    on evoltb_system_dict_key (key_);
