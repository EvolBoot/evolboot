...
public class TenantConfigResourceV1 {
    ...
    @PreAuthorize(HAS_ROLE_TENANT_OWNER + OR + CommonAccessAuthorities.Config.TENANT_HAS_UPDATE)
    ...
    @PreAuthorize(HAS_ROLE_TENANT_OWNER + OR + CommonAccessAuthorities.Config.TENANT_HAS_SINGLE)
