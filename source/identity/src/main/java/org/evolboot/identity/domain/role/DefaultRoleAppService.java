...
@Service
@Slf4j
public class DefaultRoleAppService implements RoleAppService {
    ...
    public DefaultRoleAppService(RoleCreateFactory roleCreateFactory, RoleUpdateService roleUpdateService, RoleRepository repository, RoleBatchDeleteService roleBatchDeleteService, RoleDeletePermissionService roleDeletePermissionService, RoleDeleteService roleDeleteService) {
