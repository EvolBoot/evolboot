 ...
 * source https://www.liaoxuefeng.com/article/1280526512029729#0
 * 53 bits unique id:
 * <p>
 * |--------|--------|--------|--------|--------|--------|--------|--------|
...
//    private static final Pattern PATTERN_LONG_ID = Pattern.compile("^([0-9]{15})([0-9a-f]{32})([0-9a-f]{3})$");
    ...
    /**
     * 时间戳  最高支持 53 bit(当前时间-起始时间)
     * 随机数：最高支持 16 bit，21-5 = 16,1111111111111111=65535 个
     * 机器数：最高支持 5 bit，11111= 32 台
     *
     * @param epochSecond
     * @param next
     * @param shardId
