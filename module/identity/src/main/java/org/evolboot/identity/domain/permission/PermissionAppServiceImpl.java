...
public class PermissionAppServiceImpl implements PermissionAppService {
    ...
    public PermissionAppServiceImpl(PermissionCreateFactory permissionCreateFactory, PermissionUpdateService permissionUpdateService, PermissionBatchDeleteService permissionBatchDeleteService, PermissionRepository repository, PermissionDeleteService permissionDeleteService) {
