 ...
 */
@Service
public class DefaultSecurityAccessTokenAppService implements SecurityAccessTokenAppService {

    private final EvolSessionRepository repository;
    private final LoginService loginService;

    public DefaultSecurityAccessTokenAppService(EvolSessionRepository repository, LoginService loginService) {
