...
@Slf4j
@Service
public class DefaultXarvkgvvrllncAppService extends XarvkgvvrllncSupportService implements XarvkgvvrllncAppService {


    private final XarvkgvvrllncCreateFactory factory;
    private final XarvkgvvrllncUpdateService updateService;

    protected DefaultXarvkgvvrllncAppService(XarvkgvvrllncRepository repository, XarvkgvvrllncCreateFactory factory, XarvkgvvrllncUpdateService updateService) {
        super(repository);
