...
(
    ...
    type_                            varchar(50) COMMENT '下发类型',
    internal_order_id_               varchar(100) COMMENT '内部订单号',
    amount_                          decimal(19, 2) COMMENT '金额',
    custom_name_                     varchar(50) COMMENT '客户姓名',
    custom_mobile_                   varchar(50) COMMENT '客户手机号',
    custom_email_                    varchar(100) COMMENT '客户邮箱',
    bank_bank_cardholder_name_       varchar(100) COMMENT '持卡人名称',
    ...
    request_result_status_           varchar(100) COMMENT '请求返回状态',
    ...
    notify_result_status_            varchar(100) COMMENT '通知返回状态',
