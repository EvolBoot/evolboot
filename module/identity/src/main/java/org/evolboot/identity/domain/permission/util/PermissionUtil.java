...
public final class PermissionUtil {
    ...
    public static List<Permission> convertTree(List<Permission> permissionList) {
        ...
        Map<Long, List<Permission>> permissionMap = permissionList.stream().filter(permission -> !permission.getParentId().equals(defaultParentId)).collect(Collectors.groupingBy(Permission::getParentId));
