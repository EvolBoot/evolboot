...
public class AdminConfigResourceV1 {
    ...
    @PreAuthorize(HAS_ROLE_SUPER_ADMIN + OR + CommonAccessAuthorities.Config.HAS_UPDATE)
    ...
    @PreAuthorize(HAS_ROLE_SUPER_ADMIN + OR + CommonAccessAuthorities.Config.HAS_SINGLE)
