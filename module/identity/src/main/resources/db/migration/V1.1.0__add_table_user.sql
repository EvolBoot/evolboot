...
(
    ...
    del_state_          varchar(20)        DEFAULT 'ACTIVE' COMMENT '删除状态，0 正常 , 1 删除',
    ...
    gender_             varchar(20)        default 'UNKNOWN' COMMENT '性别',
    user_identity_      smallint COMMENT '身份',
    state_              varchar(20)        default 'ACTIVE' comment '用户状态',
    user_type_          varchar(20)        default 'NORMAL' comment '用户类型,',
