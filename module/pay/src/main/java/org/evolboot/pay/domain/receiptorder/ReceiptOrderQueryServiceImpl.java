...
@Slf4j
@Service
public class ReceiptOrderQueryServiceImpl extends ReceiptOrderSupportService implements ReceiptOrderQueryService {

    protected ReceiptOrderQueryServiceImpl(ReceiptOrderRepository repository) {
        super(repository);
    }
