...
import org.evolboot.configuration.ConfigurationAccessAuthorities;
...
@AdminClient
public class AdminConfigurationResourceV1 {

    private final ConfigurationAppService service;

    public AdminConfigurationResourceV1(ConfigurationAppService service) {
    ...
    @PreAuthorize(HAS_ROLE_ADMIN + or + ConfigurationAccessAuthorities.System.HAS_UPDATE)
    ...
    @PreAuthorize(HAS_ROLE_ADMIN + or + ConfigurationAccessAuthorities.System.HAS_SINGLE)
